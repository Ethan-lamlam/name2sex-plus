...
if __name__ == "__main__":
    ...
    #load data
    f = open('namesex-master/namesex/data/namesex_data_v2.csv', 'r', newline='', encoding = 'utf8')
    mydata = csv.DictReader(f)
    sexlist = []
    namelist = []
    foldlist = []
    ...
    if mode == "explore":
        ...
        # testing data
        # import namesex_light
        filename = pkg_resources.resource_filename('namesex', 'namesex-master/namesex/data/testdata.csv')
        f = open(filename, 'r', newline='', encoding='utf8')
        mydata = csv.DictReader(f)
        testsexlist = []
        testnamelist = []
